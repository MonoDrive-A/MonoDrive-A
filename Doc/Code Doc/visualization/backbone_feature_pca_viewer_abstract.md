...
| --- | --- | --- |
| `run_backbone_feature_pca_sample` | H5 样本图像 `[8, 3, 288, 512]`，目标点 `[2]`，自车运动 `[3]` | `layer_pca_images: [12, 4, 288, 512, 3]`，`layer_token_norms: [12, 4, 18, 32]`，模型输出 BEV 数据，轨迹词表概率 `[256]`，top-k residual/correction 数据，并过滤 `none` |
