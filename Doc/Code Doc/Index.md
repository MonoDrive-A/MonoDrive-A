...
| `train/losses.py` | 汇总轨迹、Agent 和 Map 训练 loss，其中轨迹词表分数使用 BCEWithLogits，分类和 mode 使用 CE。 | [train/losses_abstract.md](train/losses_abstract.md) | [train/losses.md](train/losses.md) | 已同步 |
