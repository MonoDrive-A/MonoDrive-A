...
| `model/backbone.py` | 复用已有嵌入与解码模块，构造 2662 个 Token 的统一序列并执行 12 层 Transformer 主干，仅对视觉 Token 应用 3D RoPE。 | [model/backbone_abstract.md](model/backbone_abstract.md) | [model/backbone.md](model/backbone.md) | 已同步 |
