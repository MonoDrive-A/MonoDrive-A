...
| `model/backbone.py` | 复用已有嵌入与解码模块，构造最终 2614 个 Token 的 16 层两阶段统一序列主干，第 12 层输出接检测头，第 13 层输入前加入目标点 Token。 | [model/backbone_abstract.md](model/backbone_abstract.md) | [model/backbone.md](model/backbone.md) | 已同步 |
