...
| `detection_class_weights.agent_non_none_weight` | 见 `config/training.toml` | `manual` 为 Agent 前景类权重；`auto` 为匹配 query 组 loss 乘子。 |
| `detection_class_weights.agent_none_weight` | 见 `config/training.toml` | `manual` 为 Agent none 类权重；`auto` 为未匹配 query 组 loss 乘子。 |
| `detection_class_weights.map_non_none_weight` | 见 `config/training.toml` | `manual` 为 Map 前景类权重；`auto` 为匹配 query 组 loss 乘子。 |
| `detection_class_weights.map_none_weight` | 见 `config/training.toml` | `manual` 为 Map none 类权重；`auto` 为未匹配 query 组 loss 乘子。 |
