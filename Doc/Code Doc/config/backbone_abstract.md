...
`config/backbone.toml` 保存统一序列 Transformer 主干配置，包括子配置路径、12 层主干、8 头注意力、仅视觉 Token 使用的 3D RoPE、模态独立 FFN 层索引、身份嵌入、自车运动嵌入和精度策略。
...
- `modal_ffn_layer_indices` 是 0-based 索引，当前 `[1, 3, 5, 7, 9]` 对应文档中按 1 开始计数的第 2、4、6、8、10 层。
